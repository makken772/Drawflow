export default class Drawflow {
    ...
    addNodeImport (dataNode, precanvas) {
      ...
      if(dataNode.typenode === false) {
        ...
        if(parseInt(this.render.version) === 3 ) {
          ...
          //Vue 2
          this.noderegister[dataNode.html].props.data = dataNode.data;
          let wrapper = new this.render({
    ...
    changeModule(name, update) {
      ...
      this.zoom_last_value = 1;
      if (update) {
        let canvas_x = (this.canvas_x / this.zoom_last_value) * this.zoom;
        let canvas_y = (this.canvas_y / this.zoom_last_value) * this.zoom;
        this.precanvas.style.transform = "translate("+canvas_x+"px, "+canvas_y+"px) scale("+this.zoom+")";
        this.canvas_x = this.canvas_x;
